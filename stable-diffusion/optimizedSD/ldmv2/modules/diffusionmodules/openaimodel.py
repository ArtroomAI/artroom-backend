...
from ldmv2.modules.diffusionmodules.util import (
    checkpoint,
    conv_nd,
    linear,
    avg_pool_nd,
...
from ldmv2.modules.attention import SpatialTransformer
from ldmv2.util import exists
...
class QKVAttentionLegacy(nn.Module):
    ...
    def forward(self, qkv):
        ...
        scale = 1 / matorch.sqrt(matorch.sqrt(ch))
        weight = torch.einsum(
